...
type Business struct {
	...
	// Storefront gallery — up to 3 photos of the physical store / team / workspace.
	// Stored as a JSON array string e.g. '["url1","url2","url3"]'
	GalleryImageURLs string `gorm:"type:text;default:'[]'" json:"gallery_image_urls"`

	// Storefront promo video — link only (YouTube / Vimeo / Google Drive). No upload.
	StorefrontVideoURL *string `gorm:"size:500" json:"storefront_video_url"`
